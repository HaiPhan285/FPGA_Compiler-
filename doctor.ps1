# doctor.ps1 - Windows PowerShell wrapper for FPGA doctor
# Calls the Linux doctor.sh script through WSL
...
# Execute doctor.sh in WSL
Write-Host "Running FPGA doctor diagnostics through WSL..." -ForegroundColor Cyan

$wslCommand = "cd '$WslScriptDir' && bash ./doctor.sh"
